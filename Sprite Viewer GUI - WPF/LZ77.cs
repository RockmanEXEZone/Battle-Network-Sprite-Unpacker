...
namespace Nintenlord.GBA.Compressions
{
    static unsafe class LZ77
    {
        ...
        {
            int lenght = GetCompressedDataLength(br, offset);
        ...
        /// <returns>The lenght of the data or -1 if can't be uncompressed</returns>
        static public int GetCompressedDataLength(BinaryReader br, int offset)
        {
            int lenght = 0;
            int UncompSize = 0;
            br.BaseStream.Position = offset;
        ...
        static public int GetCompressedDataLenght(byte* source)
        {
            ...
            int decompressedLenght = (*(int*)(source)) >> 8;
        ...
        /// <param name="offset"></param>
        /// <returns></returns>
        static public int GetCompressedDataLength(byte[] data, int offset)
        {
            fixed (byte* ptr = &data[offset])
            {
        ...
        /// <summary>
        /// Decompresses data in source at offset.
        /// </summary>
        /// <param name="source"></param>
        /// <param name="offset">Offset of the data. 2 lowest bits are ignored.</param>
        /// <returns>Array of decompressed data or null if compression was unsuccessful.</returns>
        ...
        /// <summary>
        /// Decompresses LZ77 data from a stream
        /// </summary>
        /// <param name="br">Stream where the compressed data is</param>
